...
Numerous methods exist to find projects. Specific to R projects, the following sources exist:
 ...
 - [openpharma.pharmaverse.org](http://openpharma.pharmaverse.org): un-opinionated tracker of packages built by pharma for pharma use  cases. It also and indexes and provides package metadata in a dashboard, and provides metadata to  pharmaverse.org.
